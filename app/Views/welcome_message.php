...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Activity: The Test Drive</h1>

        <h2>Objective: Write a test that verifies the homepage returns HTTP 200</h2>
...
<section>
    ...
    <p>The homepage test has been created and verified for this project.</p>

    <h2>Steps implemented</h2>

    <ol>
        <li>Open the test file: <code>tests/app/Controllers/HomeTest.php</code></li>
        <li>Create the test method: <code>public function testHomePage()</code></li>
        <li>Add the assertion:
            <pre><code>$result = $this->get('/');
$result->assertStatus(200);</code></pre>
        </li>
        <li>Run the test:
